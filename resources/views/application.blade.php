...
<div class="col-lg-12" class="form-group">
 <label>Essay</label>
<textarea class="form-control" name="essay" rows="5" cols="40" placeholder="Please write us a short motivational essay about your goals and why you want to become a web developer."></textarea>
</div>
</div>
...
<form style="text-align:center; margin-bottom: 20px">
            ...
            {{ csrf_field() }}
            <button style="height:40px; width:200px;" type="submit" name"submit" class="btn draw-border">SUBMIT</button>
            </form>
