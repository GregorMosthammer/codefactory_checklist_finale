...
Thank you for your application and Welcome to the CodeFactory!
...
In order for you to enjoy and benefit from your time with us the most, here are some informations on the course of events, preparations and miscellaneous information.
...
To pay for the Fullstack-course, please wire the program fee of  18.500$ to our account at your earliest convenience:
 
Erste Bank<br>
Kontoinhaber: CodeFactory GmbH<br>
...
In general, you will work with pair-programming during your course. This means, that you will closely collaborate with one other student to create your classwork examples and projects. Through this, you will not only get to know your fellow students quickly, but you will also work with higher concentration and learn to communicate in programming terms very easily.
 
The time you spend in the course is dedicated fully to realizing your projects and tasks. The little theory that is necessary to start your work, you should read over the day before or over the weekend on your own. We promise however, that you will be able to do so quite easily ;)
...
Our online-curriculum will be available for you from the start of the course at the url lms.codefactory.wien, and you can read over every part of it at your convenience.
You will receive the login-credentials via email a week before the classes start.

For the Fullstack-course you are required to know the basics of HTML/CSS and JavaScript, either through self-study or through our basic courses for HTML / CSS and JavaScript, which we highly recommend you take as a first step into web development.
